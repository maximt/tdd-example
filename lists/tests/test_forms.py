...
from lists.forms import MSG_EMPTY_ITEM_ERROR, MSG_DUPLICATE_ITEM_ERROR, ItemForm, ExistingListItemForm, NewListForm
...
class ItemFormTest(TestCase):
    ...
    def test_form_validation_for_blank_items(self):
        ...
        self.assertEqual(form.errors['text'], [MSG_EMPTY_ITEM_ERROR])
...
class ExistingListItemFormTest(TestCase):
    ...
    def test_form_validation_for_duplicate_items(self):
        ...
        self.assertFalse(form.is_valid())
        self.assertEqual(form.errors['text'], [MSG_DUPLICATE_ITEM_ERROR])
